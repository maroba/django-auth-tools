...
from django_auth_tools.middleware import LoginRequiredMiddleware
...
@override_settings(LOGIN_URL=LOGIN_URL, ROOT_URLCONF="django_auth_tools.tests.test_middleware")
